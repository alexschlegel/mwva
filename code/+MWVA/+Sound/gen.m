...
% MWVA.Sound.gen
% 
% Description:	generate a sound sample
% 
% Syntax:	x = MWVA.Sound.gen(kSuper,kSub,<options>)
% 
% In:
%	kSuper	- the superordinate sound category
%	kSub	- the subordinate sound category
%	<options>:
